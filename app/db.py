...
class Game(db.Model):
    ...
    sender_trade = db.relationship("Trade",foreign_keys="Trade.sender_game_id",
                                   back_populates="sender_game")
    receiver_trade = db.relationship("Trade",foreign_keys="Trade.receiver_game_id",
...
class Trade(db.Model):
    ...
    sender_game_id = db.Column(db.Integer, db.ForeignKey("game.id",
                                                         ondelete="SET NULL"))
    receiver_game_id = db.Column(db.Integer, db.ForeignKey("game.id",
                                                           ondelete="SET NULL"))

    sender_game = db.relationship("Game", foreign_keys="Trade.sender_game_id",
                                  back_populates="sender_trade")
    receiver_game = db.relationship("Game",foreign_keys ="Trade.receiver_game_id",
                                    back_populates="receiver_trade")
